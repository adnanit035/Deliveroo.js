...
io.on('connection', (socket) => {
    ...
    socket.on('move', async (direction, acknowledgementCallback) => {
        ...
        try {
            ...
            console.error(direction, 'is not a method of agent');
            console.error(error)
        }
    });
    ...
    socket.on('say', (toId, msg, acknowledgementCallback) => {
        ...
        try {
            ...
            console.log(me.id, 'acknowledgement of \'say\' not possible')
        }
        ...
        for (let socket of myAuthenticator.getSockets(toId)()) {
            ...
            socket.emit('msg', me.id, me.name, msg, (reply) => {
                ...
                try {
                    ...
                    console.log(me.id, 'error while trying to acknowledge reply')
                }
    ...
    socket.on('shout', (msg, acknowledgementCallback) => {
        ...
        try {
            ...
            console.log(me.id, 'acknowledgement of \'shout\' not possible')
        }
